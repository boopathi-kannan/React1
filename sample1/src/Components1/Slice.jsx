...
const Slice = ({ title, Description, id, fetchProject}) => {
  ...
  const [DescriptionState, setToolsState] = useState(Description)
                        ...
                        <div className="h-[50%] w-[35%] flex justify-center items-center bg-[#f8f8f8] rounded-md shadow-md">
                            ...
                            <div className='h-full w-full bg-[#343434] flex flow-row justify-center items-center rounded-md shadow-md'>
                                <div className='h-[70%] w-[80%]'>
                                    ...
                                    <input type="text" className='text-gray-400 w-full h-[20%] border-[#f8f8f8] border-b p-3 text-xl focus:outline-none bg-[#343434]' value={ DescriptionState } onChange={(e) => setToolsState(e.target.value)} placeholder='Description' id="" />
